...
namespace Book_My_Table.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public CustomersController(CustomerReg context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("UserId,Firstname,Lastname,Gender,Email,Pwd,Confirmpwd")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,Firstname,Lastname,Gender,Email,Pwd,Confirmpwd")] Customer customer)
        {
        ...
        {
            return _context.CustomerRegistration.Any(e => e.UserId == id);
        }
    }
}
